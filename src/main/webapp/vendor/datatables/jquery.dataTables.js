...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		 ...
		 * (i.e. "Showing 1 to 10 of 57 entrées") DataTables will render large numbers
		...
		"oLanguage": {
			 ...
			 *
			 *  @type string
			 *  @default Showing _START_ to _END_ of _TOTAL_ entrées
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfo": "Showing _START_ to _END_ of _TOTAL_ entrées",
			 ...
			 *  @type string
			 *  @default Showing 0 to 0 of 0 entrées
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Showing 0 to 0 of 0 entrées",
